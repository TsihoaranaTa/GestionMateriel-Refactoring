<?php
	...
	$table = Departement::getTableName();
	...
	if (Departement::pasDelements()):	//test pour vérifier qu'il y a des articles dans la base
		Application::alert("aucun département trouvé!");
		Application::redir('index.php');
	endif;
	$options = Departement::loadOptions();
	...
	if(isset($_POST['btn_submit'])):
		...
		if($critere == 'id' || $critere == 'id_direction'):
			if(preg_match("~^-?[0-9]+$~i", $texte)):
				//valeur valide
				$afficherResultat = true;
			else:
				//Erreur!
				Application::alert('id/id_direction doit être numérique!');
			endif;
		else:
			$afficherResultat = true;
		endif;
			...
			<div id="site_content">
				<div id="content">
					<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					   		<h2>Recherche <?php echo $table; ?></h2><br/>

			      		<div class="form-row justify-content-center">
      					<div class="form-group col-md-5">		   		
						<input type="text" class="form-control sm-14" name="texte" placeholder="Recherche" required value="<?php echo $texte ?>">
					</div>
         			 ...
         			 <table class="table table-hover justify-content-center ">
						...
						foreach ($res as $record) {
							...
							<tr>
								...
								?>
								<?php if(Utilisateur::getUtilisateurConnecte()->estAdmin()): ?>
									<td><a href="modifier_departement.php?id=<?php echo $record['id']; ?>"><img src="../include/img/edit-icon.png" title="modifier" style="height: 24px; width: 24px;" /></a></td>
									<td><a href="supprimer_departement.php?id=<?php echo $record['id']; ?>" onclick="return(confirm('Supprimer?'))"><img src="../include/img/delete-icon.png" title="supprimer" style="height: 24px; width: 24px;" /></a></td>
								<?php endif; ?>
							</tr>
							<?php
						}
