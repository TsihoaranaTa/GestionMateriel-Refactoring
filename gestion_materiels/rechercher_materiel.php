<?php
  ...
  $title = 'recherche - ' . $table;
	...
	if(Materiel::pasDelements()):	//test pour vérifier qu'il y a des matériels dans la base
		Application::alert("aucun matériel trouvé!");
		Application::redir('index.php');
	endif;
  $options = Materiel::loadOptions();
  ...
  if(isset($_POST['btn_submit'])):
    ...
    if($critere == 'id' || $critere == 'id_direction' || $critere == 'id_departement'):
  ...
  <div id="main">
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
      ...
      <div class="form-group col-md-5">
        ...
        <input type="text" class="form-control sm-2" name="texte" required value="<?php echo $texte; ?>" id="inlineFormInputMD" placeholder="Recherche" >
          ...
          <table class="table table-hover justify-content-center ">
            ...
            <?php
              foreach ($res as $record) {
                ...
                ?>
                <?php if(Utilisateur::getUtilisateurConnecte()->estAdmin()): ?>
                	<td><a href="modifier_materiel.php?id=<?php echo $record['id']; ?>"><img src="../include/img/edit-icon.png" title="modifier" style="height: 24px; width: 24px;" /></a></td>
                	<td><a href="supprimer_materiel.php?id=<?php echo $record['id']; ?>" onclick="return(confirm('Supprimer?'))"><img src="../include/img/delete-icon.png" title="supprimer" style="height: 24px; width: 24px;" /></a></td>
                <?php endif; ?>
                </tr>
                <?php
              }
