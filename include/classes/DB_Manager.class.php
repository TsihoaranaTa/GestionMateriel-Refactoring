...
/**
 * 
 * Cette classe a un seul but retourner les enregistrements suite à une requete
...
class DB_Manager {
	...
	public static $NOT_SELECT = 2;	//retourné si la requete est du type autre que select
	public static $NOT_A_ROW = 3;	//retourné si la ligne de value de la base est introuvable
	public static $NO_RESULTS = 4;	//retourné si la requête ne retourne aucune ligne
	
	//constructeur
	public function DB_Manager() {	
		try {
			$this->_db = new PDO('mysql:host=localhost;dbname=adwya2', 'root', '');
	...
	private function queryDB($sql, $estSelect = true) {	
		//par defaut la requete retourne une valeur
