<?php
  ...
  $title = 'recherche - ' . $table;
	...
	if(Service::pasDelements()):	//test pour vérifier qu'il y a des services dans la base
		Application::alert("aucun service trouvé!");
		Application::redir('index.php');
	endif;
  $options = Service::loadOptions();
          ...
          <table class="table table-hover justify-content-center ">
            ...
            <?php
              foreach ($res as $record) {
                ...
                ?>
                <?php if(Utilisateur::getUtilisateurConnecte()->estAdmin()): ?>
                	<td><a href="modifier_service.php?id=<?php echo $record['id']; ?>"><img src="../include/img/edit-icon.png" title="modifier" style="height: 24px; width: 24px;" /></a></td>
                	<td><a href="supprimer_service.php?id=<?php echo $record['id']; ?>" onclick="return(confirm('Supprimer?'))"><img src="../include/img/delete-icon.png" title="supprimer" style="height: 24px; width: 24px;" /></a></td>
                <?php endif; ?>
                </tr>
                <?php
              }
