<?php
	...
	if(Direction::pasDelements()):	//test pour vérifier qu'il y a des gadgets dans la base
		Application::alert("aucune direction trouvé!");
		Application::redir('index.php');
	endif;
	$options = Direction::loadOptions();
		...
		<div id="header">
			<div id="site_content">
				<div id="content">
					...
					<input type="text" name="texte" class="form-control sm-14" required placeholder="Recherche" value="<?php echo $texte; ?>">
					        </div>
 		   				      ...
 		   				      <table class="table table-hover justify-content-center ">
									...
									foreach ($res as $record) {
										...
										<tr>
											...
											?>
											<?php if(Utilisateur::getUtilisateurConnecte()->estAdmin()): ?>
												<td><a href="modifier_direction.php?id=<?php echo $record['id']; ?>"><img src="../include/img/edit-icon.png" title="modifier" style="height: 24px; width: 24px;" /></a></td>
												<td><a href="supprimer_direction.php?id=<?php echo $record['id']; ?>" onclick="return(confirm('Supprimer?'))"><img src="../include/img/delete-icon.png" title="supprimer" style="height: 24px; width: 24px;" /></a></td>
											<?php endif; ?>
										</tr>
										<?php
									}
